...
namespace fs {
  ...
  protected:
    ...
    /**
     *  A string describing the value to be set in detail.
     */
  ...
  public:
     ...
     */
    ClapSingleArgument(fs::CommandlineParser & parser, std::string const & flag, std::string const & valueType, std::string const & description, bool isRequired = true, bool isSwitch = false);
    
    /**
     *  Constructor setting some constraints to the vlaues.
     *  This constructor sets constraints to the values.
     */
    ClapSingleArgument(fs::CommandlineParser & parser, std::string const & flag, std::set<T>  const & valueConstraints, std::string const & valueType, std::string const & description, bool isRequired = true, bool isSwitch = false);
     ...
     *
     */
    ClapSingleArgument(fs::CommandlineParser& parser, char const & flag, std::string const & valueType, std::string const & description, bool isRequired = true, bool isSwitch = true);
